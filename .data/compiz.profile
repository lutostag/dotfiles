...
s0_alt_tab_forward = <Super>Tab
s0_alt_tab_prev = <Shift><Super>Tab
s0_alt_tab_forward_all = <Control><Super>Tab
s0_alt_tab_prev_all = <Shift><Control><Super>Tab
s0_alt_tab_next_window = <Alt><Super>Tab
s0_alt_tab_prev_window = <Shift><Alt><Super>Tab
...
s0_run_command1_key = <Super>Return
...
[grid]
s0_put_center_key = <Shift><Super>p
s0_put_left_key = <Shift><Super>h
s0_put_right_key = <Shift><Super>l
s0_put_top_key = <Shift><Super>k
s0_put_bottom_key = <Shift><Super>j
s0_put_topleft_key = <Shift><Super>y
s0_put_topright_key = <Shift><Super>i
s0_put_bottomleft_key = <Shift><Super>u
s0_put_bottomright_key = <Shift><Super>o
s0_put_maximize_key = Disabled
s0_put_restore_key = <Shift><Super>z
...
s0_unredirect_match = (any) & !(class=Totem) & !(class=Mplayer) & !(class=Vlc) & !(class=Plugin-container) & !(class=Firefox) & !(class=Dmenu)
...
s0_toggle_fullscreen_key = <Super>x
...
[decor]
s0_active_shadow_radius = 0.600000
...
[put]
s0_put_viewport_1_key = <Shift><Super>exclam
s0_put_viewport_2_key = <Shift><Super>at
s0_put_viewport_3_key = <Shift><Super>numbersign
s0_put_viewport_4_key = <Shift><Super>dollar
s0_put_viewport_5_key = <Shift><Super>percent
s0_put_viewport_6_key = <Shift><Super>asciicircum
...
[core]
s0_active_plugins = core;composite;opengl;resize;compiztoolbox;snap;place;vpswitch;put;regex;imgpng;copytex;commands;grid;wall;move;mousepoll;session;unitymtgrabhandles;animation;workarounds;fade;expo;scale;addhelper;ezoom;unityshell;
